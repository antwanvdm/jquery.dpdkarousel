...
(function ($) {
    ...
    var methods = {
        ...
        init: function ($element) {
            ...
            this.cWidth = this.settings.widthIsFluid ? $(window).width() : this.settings.width;
            ...
            $(window).on('resize', _.bind(_.debounce(this.resizeHandler, 200), this));
        },
        ...
        animateSlides: function (direction) {
            ...
            var marginLeftNumber = (direction == "next" ? "-" : "") + this.cWidth;
            ...
            $animateSlideOut.removeClass("active").transition({marginLeft: marginLeftNumber + "px"}, this.settings.animationDuration, this.settings.animationEasing, _.bind(function () {
                $animateSlideOut.css({marginLeft: this.cWidth});
            ...
            if (direction == "previous") {
                this.$el.find(this.settings.animateEl).eq(this.currentActiveSlide).css({marginLeft: "-" + this.cWidth + "px"});
            }
        ...
        resizeHandler: function (e) {
            ...
            this.$el.find(this.settings.animateEl).not(':eq(' + this.currentActiveSlide + ')').css('margin-left', this.cWidth);

            //If resizeHeight is not false, resize like a boaws
            if (this.settings.resizeHeight !== false) {
                this.$el.height($(window).height() - this.settings.resizeHeight);
            }

            //If percentage height, we set it on resize
            if (this.settings.heightIsPercentage) {
                this.$el.height($(window).height() * this.settings.height);
            }
        },
